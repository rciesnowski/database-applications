...
class Controller {
    ...
    Label pesel4, miasto4, kod_pocztowy4, telefon4, email4, err1, err2;
    ...
    public Controller(BorderPane okno) {
        ...
        dalej.setOnAction(e -> {
            ...
            if (next) {
                ...
                this.insertText.getChildren().addAll(new Label("********"), new Label("********"), new Label("********"), new Label("********"), new Label("********"), new Label("********"));
            }
        });
...
public class Edytka extends Application {
    @Override
